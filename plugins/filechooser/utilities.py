...
class UserDirectories:
    ...
    def __init__(self):
        ...
        # Fill the dictionary
        self._retreive_XDG_directories()
    ...
    def get_XDG_path(self, XDG_name):
        if XDG_name in self.XDG_directories.keys():
            return self.XDG_directories[XDG_name]
        else:
            return os.path.expanduser(self.default[XDG_name])


    # Get full path to current users predefined directory
    def _retreive_XDG_directories(self):
